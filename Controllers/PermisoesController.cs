...
namespace EntreEspeciesNuevo.Controllers
{
    public class PermisoesController : Controller
    {
        ...
        public PermisoesController(EntreespeciessqlContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Permisos != null ? 
                          ...
                          Problem("Entity set 'EntreespeciessqlContext.Permisos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EntreespeciessqlContext.Permisos'  is null.");
            }
            var permiso = await _context.Permisos.FindAsync(id);
            if (permiso != null)
            {
